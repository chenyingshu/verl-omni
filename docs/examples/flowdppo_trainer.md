...
Follow the [installation guide](../start/install.md) to set up the base environment, then install the OCR reward dependency:
...
See [Algorithms - Flow-DPPO](../algo/flowdppo) for the mathematical objective and references.