...
For algorithm details, see [Algorithms - GRPO-Guard](../algo/grpo_guard.md). For the base Flow-GRPO setup this example builds on, see  [Examples - FlowGRPO Trainer](flowgrpo_trainer.md).
