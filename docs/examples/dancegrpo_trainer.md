...
For the base Flow-GRPO setup, see [Examples - FlowGRPO Trainer](flowgrpo_trainer). For algorithm details, see [Algorithms - Flow-DPPO](../algo/flowdppo).

## Installation

Follow the [installation guide](../start/install.md) to set up the base environment.
...
See the [Metrics Documentation](../start/metrics.md) for a full description of all diffusion-specific training metrics.