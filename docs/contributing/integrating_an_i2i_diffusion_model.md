...
{doc}`../examples/qwen_image_edit/flowgrpo_trainer_qwen_image_edit`.
...
Use the [Qwen-Image-Edit training guide](../examples/qwen_image_edit/flowgrpo_trainer_qwen_image_edit.md) as a
