...
For the base Flow-GRPO setup, see [Examples - FlowGRPO Trainer](../../docs/examples/flowgrpo_trainer.md). For algorithm details, see [Algorithms - Flow-GRPO](../../docs/algo/flowgrpo.md).
