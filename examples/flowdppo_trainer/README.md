...
Flow-DPPO reuses the FlowGRPO training stack, but replaces ratio clipping with a divergence-based mask over denoising transitions. For algorithm details, see [Algorithms - Flow-DPPO](../../docs/algo/flowdppo.md); for the shared Qwen-Image OCR setup, see [Examples - FlowGRPO Trainer](../../docs/examples/flowgrpo_trainer.md).
